 ...
 */
public class FastXmlPerfTest extends PerfTestSupport implements PerfTest {
    ...
    public void parseXml2PersionObject(byte[] ba) throws ParseException, NumberFormatException {
    ...
    public String getCaseName() {
        return "***FastXml***(for normal files)";
    }
}
